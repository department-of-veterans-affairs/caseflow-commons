...
# If a class that is constantized in here is brought into commons from caseflow,
# remove the string and constantize from here for that class
  ...
  class Fakes::VBMSService
    ...
    def self.load_vbms_ids_mappings
      ...
      CSV.foreach(file_path, headers: true) do |row|
        ...
        caseflow_appeal_data_class = "Fakes::Data::AppealData".constantize
        @document_records[vbms_id] = caseflow_appeal_data_class.document_mapping[row_hash["documents"]]
    ...
    def self.get_dispositions!(claim_id:)
      caseflow_fakes_bgs_service = "Fakes::BGSService".constantize
      caseflow_fakes_bgs_service.end_product_store.inflated_dispositions_for(claim_id) || []
    end

    def self.fetch_contentions(claim_id:)
      caseflow_fakes_bgs_service = "Fakes::BGSService".constantize
      caseflow_fakes_bgs_service.end_product_store.inflated_contentions_for(claim_id) || []
    end
    ...
    def self.remove_contention!(contention)
      ...
      caseflow_fakes_bgs_service = "Fakes::BGSService".constantize
      caseflow_fakes_bgs_service.end_product_store.remove_contention(contention)
    ...
    def self.update_contention!(contention)
      ...
      caseflow_fakes_bgs_service = "Fakes::BGSService".constantize
      caseflow_fakes_bgs_service.end_product_store.update_contention(contention)
